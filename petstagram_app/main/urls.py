...
from petstagram_app.main.views.generic import HomeView, DashboardView
from petstagram_app.main.views.pet_photos import PetPhotoDetailsView, EditPetPhotoView, \
    like_pet_photo, CreatePetPhotoView
from petstagram_app.main.views.pets import CreatePetView, EditPetView, DeletePetView
